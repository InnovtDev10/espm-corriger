      ...
      <main className="center p-3">
        ...
        <section className="contenu2 mt-3 p-4">
          <div className="header-section">
            <h4 className="fw-bold">Bilan Financier</h4>
          </div>
          ...
          <div className="finance-container mt-5">
            ...
            <div className="stats-container ">
              <div className="stat-card">
                <h5>Total Somme encaissée (Droit&Autre Frais)</h5>
                <p>{totalMontantPaye} Ar</p>
              </div>
              <div className="stat-card">
                <h5>Total Somme en Attente (Droit&Autre Frais)</h5>
                <p>{totalMontantReste} Ar</p>
              </div>
              <div className="stat-card">
                <h5
              ...
              <div className="stat-card">
                ...
                <p>{totalMontantPayeFrais} Ar</p>
              </div>
              <div className="stat-card">
                <h5 onClick={() => navigate("/frais")} title="Voir les détails">
                  Total Autres Frais en Attente
                </h5>
                <p>{totalMontantResteFrais} Ar</p>
              </div>
              <div className="stat-card">
                <h5
                  onClick={() => navigate("/classe")}
                  title="Voir les détails"
                >
                  Total Droit en Attente
                </h5>
                <p>{totalMontantResteDroit} Ar</p>
              </div>
...
export default FinanceGenerale;
